...
export const FanConvq = ({ gray = false, white = false, green = false }) => {
  return (
    <div
      className="line"
      style={{ transform: 'translateX(3px) translateY(3px)', display: 'inline-block', marginRight: '5px' }}
    >
      <svg
